...
def get_catalog():
    ...
    for potion in result:
        ...
        with db.engine.begin() as connection:
            returnList = connection.execute(sqlalchemy.text (""" SELECT SUM(quantity) AS potion_quantity FROM potion_ledger WHERE potion_id = :potion_id;"""), [{"potion_id" : potion.potion_id}]).first()
